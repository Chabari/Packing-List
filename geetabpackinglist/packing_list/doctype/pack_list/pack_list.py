...
class PackList(Document):
    ...
    def get_submitted_sales_invoices_and_items(self):
        ...
        #     frappe.throw(_("Please select the Territory/Route Filter"),title=_("Territory/Route Required"))
        ...
        """ Pull sales invoices which are draft based on criteria selected"""
